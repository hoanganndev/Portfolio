import aboutImage from "@/assets/img/about/about_hoangan.jpg";
import aboutFrame from "@/assets/img/about/550x640.jpg";
import myCV from "@/assets/CV-NguyenHoangAn-Web-Developer.pdf";
            ...
            <div className="author_wrap">
              <div className="leftbox">
                ...
                >
                  <div className="image layer" data-depth="0.2">
                    <img src={aboutFrame} alt="550x640" />
                    <div
                      className="inner"
              ...
              <div className="rightbox">
                ...
                <div className="definition">
                  <p>
                    Hi! My name is <strong>Alan Michaelis</strong>. I am a Web Developer,
                    and I'm very passionate and dedicated to my work. With 20 years
                    ...
                    concept and execution, but I find the most satisfaction in seeing the
